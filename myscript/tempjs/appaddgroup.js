...
const group1 = { "id": 1, "mainGroup": null, "groupName": "main", "parentId": null, "children": [], "parentGroup": [] ,"shopId":"shopa"}
...
const getInit = async () => {
  try {
    ...
    const myheaderInit={ headers: {'Content-Type': 'application/json'} }
    const myInit={
      shopName:"shopa",
      confirm_password:"vrp27sugar"
    }
    
    await axios.post(`http://${mainUrl}/spgroup/init`,myInit,myheaderInit)
